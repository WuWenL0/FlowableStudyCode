...
public class Test12 {
    ...
    public void startProcess() {
        ...
        variables.put("num", 5);
        ProcessInstance processInstance = runtimeService.startProcessInstanceById("holiday-inclusive:1:32504", variables);
    ...
    public void completeTask() {
        ...
        Task task = taskService.createTaskQuery()
                .processDefinitionId("holiday-inclusive:1:32504")
                .taskAssignee("i3")
                .singleResult();
